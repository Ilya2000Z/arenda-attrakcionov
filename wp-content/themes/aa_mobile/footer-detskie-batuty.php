        <footer class="footer">
            <div class="footer__wrapper container"><a class="footer__logo" href="#">
                    <svg class="footer__svg" width="80" height="80" viewBox="0 0 38 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 24.5L1.5 41.5H9.5L19 24.5H12Z" stroke="white"></path>
                        <path d="M21.5 25L18 31.5L24.5 41.5H31.5L21.5 25Z" stroke="white"></path>
                        <path d="M34 16.5H8.8313L12 22.5H37L34 16.5Z" stroke="white"></path>
                        <path d="M16 8.5L8.5 14.5V8L16 2V8.5Z" fill="white" stroke="white"></path>
                        <path d="M27.5 1L12 14.5H21L31 5.5L27.5 1Z" stroke="white"></path>
                    </svg></a>
                <div class="footer__right">
                    <div class="footer__about">
                        <p class="footer__title">О нас</p>
                        <p class="footer__text">Все оборудование, которое мы предлагаем в аренду находится у нас в собственности.  Найдём решение для мероприятий любой сложности.</p>
                    </div>
                    <div class="footer__socials">
                        ...
                        <div class="footer__icons">
                            <a href="https://www.facebook.com/arendaattrakcionov.ru" target="_blank">
                                ...
                                <a href="https://vk.com/arenda.attrakcion" target="_blank"><img class="contacts__social" src="<?php echo get_template_directory_uri(); ?>/images/vystavok_promo/images/partials/socials/vk-white.svg" alt=""/></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container footer__copyright">© 2015 — 2021 г. Аренда эвент аттракционов в Москве и Московской области. Все права защищены.</div>
        </footer>
        ...
        <script src="<?php echo get_template_directory_uri(); ?>/js/polev_kuhnya/scripts.min.js" defer></script>
