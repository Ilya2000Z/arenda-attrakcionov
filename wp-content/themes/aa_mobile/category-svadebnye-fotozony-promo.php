<?php
    get_header('svadebnye-fotozony-promo');
?>
<body>
   <header class="header header_vypusknoy">
      <div class="header__video">
      <video class="header__source" autoplay="" muted="" loop="" poster="<?php echo get_template_directory_uri(); ?>/images/partials/backgrounds/background_vypusknoy.jpg">
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_vypusknoy_1366x500.webm" type="video/webm" media="(max-width: 1200px"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_vypusknoy_1366x500.ogv" type="video/ogv" media="(max-width: 1200px"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_vypusknoy_1366x500.mp4" type="video/mp4" media="(max-width: 1200px"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_vypusknoy_1920x700.webm" type="video/webm"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_vypusknoy_1920x700.ogv" type="video/ogv"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_vypusknoy_1920x700.mp4" type="video/mp4"/>
        </video>
      </div>
      ...
      <div class="header__wrapper header__container">
                ...
                <div class="header__catalog">
                  ...
                  <?php
                    $menu_stuff = array(
                          ...
                          'depth'           => 1,
                          'walker'          => new magomra_walker_nav_menu); //new catListWalker());
                    ?>
        ...
        <div class="header__body">
          <div class="header__center">
            <h1 class="header__title title">Развлечения и активности для свадебных торжеств</h1>
            <p class="header__text">
            Фотозоны, классическое и кулинарное казино, аркадные аппараты, веселые розыгрыши, мебель ...
            </p><span class="header__button button">Каталог идей</span>
          </div>
        </div>
      </div>
    </header>
    <section class="advantages section">
      <div class="container">
        ...
        <div class="advantages__wrapper">
          <div class="item">
            <figure class="item__figure"><img class="item__image" src="<?php echo get_template_directory_uri(); ?>/images/partials/advantages/carousel.svg" alt="Большой ассортимент аттракционов"/></figure>
            <p class="item__heading">Большой ассортимент свадебных активностей</p>
          </div>
          <div class="item">
            <figure class="item__figure"><img class="item__image" src="<?php echo get_template_directory_uri(); ?>/images/partials/advantages/fair-ship.svg" alt="Подберем аттракционы на любую тематику"/></figure>
            <p class="item__heading">Своя площадка для проведения ваших торжеств</p>
          </div>
          <div class="item">
            <figure class="item__figure"><img class="item__image" src="<?php echo get_template_directory_uri(); ?>/images/partials/advantages/brainstorming.svg" alt="Лучшая анимационная группа и профессиональные инструктора"/></figure>
            <p class="item__heading">Индивидуальный подход к каждому клиенту</p>
          </div>
        </div>
      </div>
    </section>
    <section class="installation section">
      <div class="container">
        <h2 class="title">Каталог идей</h2>
...
<svg class="installation__list" height="48" viewBox="0 0 48 48" width="48" xmlns="http://www.w3.org/2000/svg"><path d="M8 28h8v-8H8v8zm0 10h8v-8H8v8zm0-20h8v-8H8v8zm10 10h24v-8H18v8zm0 10h24v-8H18v8zm0-28v8h24v-8H18z"/><path d="M0 0h48v48H0z" fill="none"/></svg>
        ...
        <?php echo '<div class="installation__wrapper installation__wrapper-active">';
            ...
            while($query->have_posts())
            {
                ...
                $query->the_post();
                get_template_part( 'loop', 'svadebnye-fotozony' );
                $i++;
            }
            wp_reset_postdata();
      ...
      <div class="contacts__wrapper container">
        ...
        <div class="contacts__right">
          <form class="contact-form">
            ...
            <input type="hidden" name="admin_email" value="Заявка :: Оборудование для Свадьбы"/>
            <input type="hidden" name="form_subject" value="Обратный звонок с сайта"/>
            <input type="hidden" name="admin_data" value="Заявка :: Оборудование для Свадьбы"/>
            <div class="contact-form__group">
              <p class="contact-form__label">Имя</p>
              <input class="contact-form__control" type="text" name="name" placeholder="Тархунов Заур" required="required"/>
            </div>
            <div class="contact-form__group">
...
<?php
        ...
        echo "</div>";
        */
    get_footer('svadebnye-fotozony-promo');
?>