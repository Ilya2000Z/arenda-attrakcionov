...
var ingEventsConfig = {
    ...
    idsYM  :[24366505],   //Yandex Metrika id array
...
document.addEventListener( 'wpcf7mailsent', function( event ) {
	if(event.detail.contactFormId=="22099"){
		ingEvents.dataLayerPush('dataLayer', {'event': 'feedback'});
	} else if(event.detail.contactFormId=="22133"){
		ingEvents.dataLayerPush('dataLayer', {'event': 'zakaz'});
	} else if(event.detail.contactFormId=="34162"){
		ingEvents.dataLayerPush('dataLayer', {'event': 'price'});
	}
}, false );