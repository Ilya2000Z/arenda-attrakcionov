...
restoreTitle : 'Щелкните, чтобы уменьшить изображение',
loadingText : 'Загрузка...',
loadingTitle : 'Остановить',
loadingOpacity : 0.75,
focusTitle : 'Щелкните для перемещения',
...
fullExpandTitle : 'Фактический размер',
fullExpandPosition : 'низ право',
fullExpandOpacity : 1,
showCredits : true, // you can set this to false if you want
creditsText : '<img src="logo.png">',
creditsHref : '#',
creditsTitle : 'Щелкните для того, чтобы перейти на главную страницу',
