...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			// Вариант 1
			/*
			'path'          => dirname($_SERVER['DOCUMENT_ROOT']),                 // path to files (REQUIRED)
			...
			*/
			...
			// Пути временных папок
			'quarantine' => dirname(__FILE__).'/../temp/.quarantine/', // i'm using a relative path, you can try an absolute one
			'tmpPath'    => dirname(__FILE__).'/../temp/.tmp',
			'tmbPath'    => dirname(__FILE__).'/../temp/.tmb',
			...
			// Добавить для загрузки *.php файлов - 'text/php'
