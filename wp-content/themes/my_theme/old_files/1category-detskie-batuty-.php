<?php
    get_header('detskie-batuty');
?>
<body>
   <header class="header header_deti">
      <div class="header__video">
        <video class="header__source" autoplay="" muted="" loop="" poster="<?php echo get_template_directory_uri(); ?>/images/partials/backgrounds/background_deti.jpg">
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_deti_1366x500.webm" type="video/webm" media="(max-width: 1200px"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_deti_1366x500.ogv" type="video/ogv" media="(max-width: 1200px"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_deti_1366x500.mp4" type="video/mp4" media="(max-width: 1200px"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_deti_1920x700.webm" type="video/webm"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_deti_1920x700.ogv" type="video/ogv"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_deti_1920x700.mp4" type="video/mp4"/>
        </video>
      </div>
      ...
      <div class="header__wrapper header__container">
        ...
        <div class="header__body">
          <div class="header__center">
            <h1 class="header__title title">Идеи для детских праздников и дней рождений</h1>
            <p class="header__text">
            Надувные батуты, сухие бассейны, качалки, карусели, эстафеты и сладкий кейтеринг...
      ...
      <div class="container">
        ...
        <div class="advantages__wrapper">
          <div class="item">
            ...
            <p class="item__heading">Большой ассортимент аттракционов</p>
          </div>
          <div class="item">
            ...
            <p class="item__heading">Подберем аттракционы на любую тематику</p>
          </div>
          <div class="item">
            ...
            <p class="item__heading">Лучшая анимационная группа и профессиональные инструктора</p>
          </div>
        </div>
      </div>
    </section>
...
<svg class="installation__list" height="48" viewBox="0 0 48 48" width="48" xmlns="http://www.w3.org/2000/svg"><path d="M8 28h8v-8H8v8zm0 10h8v-8H8v8zm0-20h8v-8H8v8zm10 10h24v-8H18v8zm0 10h24v-8H18v8zm0-28v8h24v-8H18z"/><path d="M0 0h48v48H0z" fill="none"/></svg>
        ...
        <?php echo '<div class="installation__wrapper installation__wrapper-active">';
            ...
            while($query->have_posts())
            {
                ...
                $query->the_post();
                get_template_part( 'loop', 'detskie-batuty' );
                $i++;
            }
            wp_reset_postdata();
      ...
      <div class="contacts__wrapper container">
        ...
        <div class="contacts__right">
          <form class="contact-form">
            ...
            <input type="hidden" name="admin_email" value="Заявка :: Оборудование для Выпускного"/>
            <input type="hidden" name="form_subject" value="Обратный звонок с сайта"/>
            <input type="hidden" name="admin_data" value="Заявка :: Оборудование для Выпускного"/>
