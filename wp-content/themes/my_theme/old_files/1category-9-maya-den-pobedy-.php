...
<body>
   <header class="header header_may-ninth">
      <div class="header__video">
        <video class="header__source" autoplay="" muted="" loop="" poster="<?php echo get_template_directory_uri(); ?>/images/partials/backgrounds/background_may-ninth.jpg">
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_armeyskiye-polevyye-kukhni_1920х700.webm" type="video/webm"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_armeyskiye-polevyye-kukhni_1920х700.ogv" type="video/ogv"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_armeyskiye-polevyye-kukhni_1920x700.mp4" type="video/mp4"/>
        </video>
      </div>
      ...
      <div class="header__wrapper header__container">
        ...
        <div class="header__body">
          <div class="header__center">
            <h1 class="header__title title">Аренда аттракционов для организации Дня Победы</h1>
            <p class="header__text">
            и выездная военно-полевая кухня
    ...
    <section class="installation section">
      <div class="container">
        ...
        <div class="installation__new installation__new-active">
    <?php
