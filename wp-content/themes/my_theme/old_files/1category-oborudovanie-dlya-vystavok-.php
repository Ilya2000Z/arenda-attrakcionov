<?php
    get_header('vystavok_promo');
?>
<body>
   <header class="header header_expo">
      <div class="header__video">
        <video class="header__source" autoplay="" muted="" loop="" poster="<?php echo get_template_directory_uri(); ?>/images/partials/backgrounds/background_expo.jpg">
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_arenda-attrakcionov_1920х700.webm" type="video/webm"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_arenda-attrakcionov_1920х700.ogv" type="video/ogv"/>
          <source src="<?php echo get_template_directory_uri(); ?>/images/videos/bg_arenda-attrakcionov_1920х700.mp4" type="video/mp4"/>
        </video>
      </div>
      ...
      <div class="header__wrapper header__container">
        ...
        <div class="header__body">
          <div class="header__center">
            <p class="header__subtitle subtitle">быстро, качественно, легко</p>
            <h1 class="header__title title">Аренда оборудования для выставок</h1>
            <p class="header__text"></p><span class="header__button button">Выбрать аттракцион</span>
          </div>
        </div>
      </div>
    </header>
    <section class="advantages section">
      <div class="container">
        <!--h2.subtitle быстро, качественно, легко-->
        <!--p.title Выставки. Конференции. Форумы.-->
        <p class="title">Наши преимущества</p>
        <div class="advantages__wrapper">
          <div class="item">
            <figure class="item__figure"><img class="item__image" src="<?php echo get_template_directory_uri(); ?>/images/partials/advantages/like.svg" alt=""/></figure>
            <p class="item__heading">Современное оборудование</p>
            <p class="item__text">Используем новейшее оборудование и необычный подход, что гарантирует вам, так называемый "ВАУ!" эффект у гостей.</p>
          </div>
          <div class="item">
            <figure class="item__figure"><img class="item__image" src="<?php echo get_template_directory_uri(); ?>/images/partials/advantages/stars.svg" alt=""/></figure>
            <p class="item__heading">Широкий ассортимент услуг</p>
            <p class="item__text">Любые фотозоны по вашему запросу, интерактивные столы, фотоистории, денежные автоматы, VR оборудование и многое другое</p>
          </div>
          <div class="item">
            <figure class="item__figure"><img class="item__image" src="<?php echo get_template_directory_uri(); ?>/images/partials/advantages/wow.svg" alt=""/></figure>
            <p class="item__heading">Профессиональная команда</p>
            <p class="item__text">Команда энергичных и целеустремленных профессионалов, использующих индивидуальный подход к каждому мероприятию</p>
          </div>
        </div>
      </div>
    </section>
    <section class="installation section">
      <div class="container">
        <h2 class="subtitle">Форумы, конференции, выставки</h2>
        ...
        <?php echo '<div class="installation__wrapper installation__wrapper-active">';
            ...
            while($query->have_posts())
            {
                ...
                $query->the_post();
                get_template_part( 'loop', 'vystavka_promo' );
                $i++;
            }
            wp_reset_postdata();
